  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        {/* Type Badge */}
        <div className={`absolute top-4 left-4 flex items-center space-x-1 px-3 py-1.5 rounded-full text-sm font-bold shadow-lg ${property.type === 'sale' ? 'bg-gradient-to-r from-green-400 to-emerald-500 text-white' : 'bg-gradient-to-r from-blue-400 to-indigo-500 text-white'}`}>
          <span>{property.type === 'sale' ? 'For Sale' : 'For Rent'}</span>
        </div>

        {/* Featured Badge */}
        {property.featured && (
          <div className="absolute top-14 left-4 flex items-center space-x-1 bg-gradient-to-r from-yellow-400 to-orange-400 text-gray-900 px-3 py-1.5 rounded-full text-sm font-bold shadow-lg">
          ...
          <div>
            <div className="flex items-baseline">
              ...
              <span className="text-gray-500 text-sm ml-2">
                {property.type === 'sale' ? '' : '/ night'}
              </span>
            </div>
          </div>
          <div className="flex items-center text-blue-600 font-semibold group-hover:gap-2 transition-all">
            <span className="text-sm">{property.type === 'sale' ? 'Buy Now' : 'Book Now'}</span>
